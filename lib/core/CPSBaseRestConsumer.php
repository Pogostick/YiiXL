...
/**
 * CPSBaseRestConsumer provides a convenient base class for calling REST APIs.
 *
 ...
 * onRequestComplete
 *
 * Each are called respectively and pass the handler a CPSRestEvent object with details of the call.
 */
class CPSBaseRestConsumer extends CPSComponent
{
	//********************************************************************************
	//* Properties
	//********************************************************************************
	...
	protected function makeRequest( $subType = '/', $requestData = null, $requestMethod = 'GET' )
	{
		...
		if ( $this->_debugLevel > 3 )
			CPSLog::trace( __METHOD__, 'Calling onBeforeRestCall' );
	 ...
	 */
	public function onBeforeRestCall( CPSApiEvent $event )
	{
	 ...
	 * @return boolean
	 */
	public function beforeRestCall( CPSApiEvent $event )
	{
		return true;
	}
	 ...
	 * @param CPSApiEvent $event
	 */
	public function onAfterRestCall( CPSApiEvent $event )
	{
	 ...
	 * @return boolean
	 */
	public function afterRestCall( CPSApiEvent $event )
	{
		return true;
	}
