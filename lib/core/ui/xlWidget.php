...
/**
 * xlWidget
 * Pretty much identical to xlComponent but offers a little bit of extra functionality.
 * Forced to not be a descendent of {@see CIXComponent} because of the depth of the
 * {@see CInputWidget} heirarchy. Thus this object duplicates {@see xlComponent}.
 */
class xlWidget extends CInputWidget implements xlIComponent
{
	//********************************************************************************
	//* Constants
	//********************************************************************************
	 ...
	 */
	const
		CLASS_LOG_TAG = 'yiixl.core.ui.xlWidget';
