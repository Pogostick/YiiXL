...
/**
 * CXLApiComponent provides a convenient base class for API access.
 *
 ...
 * onRequestComplete
 *
 * Each are called respectively and pass the handler a CXLApiEvent
 * object with details of the call.
 */
class CXLApiComponent extends CXLComponent
{
	//********************************************************************************
	//* Constants
	//********************************************************************************
	 ...
	 * Our logging tag
	 */
	const	CLASS_LOG_TAG = 'yiixl.core.components.CXLApiComponent';
	 ...
	 * @var string
	 */
	protected $_userAgent = 'YiiXL; (+http://www.pogostick.com/yiixl)';
	/**
	 * @var string
	 */
	...
	protected function makeRequest( $subType = '/', $requestData = null, $requestMethod = 'GET' )
	{
		...
		{
			case PS::OF_XML:
				$_response = CXLTransform::arrayToXml( json_decode( $_response, true ), 'Results' );
				break;
	 ...
	 *
	 * @param CXLApiEvent $event
	 */
	public function onBeforeApiCall( CXLApiEvent $event )
	{
	 ...
	 * @return boolean
	 */
	public function beforeApiCall( CXLApiEvent $event )
	{
		return true;
	}
	 ...
	 * @param CXLApiEvent $event
	 */
	public function onAfterApiCall( CXLApiEvent $event )
	{
	 ...
	 * @return boolean
	 */
	public function afterApiCall( CXLApiEvent $event )
	{
		return true;
	}
	 ...
	 * @param CXLApiEvent $event
	 */
	public function onRequestComplete( CXLApiEvent $event )
	{
	 ...
	 * @return boolean
	 */
	public function requestComplete( CXLApiEvent $event )
	{
		return true;
	}
